...
Reported by **36** distros on [repology.org](https://repology.org/project/websocat). **17** are ✅ on the latest upstream release, **14** are ⚠️ on an older version.
...
_Snapshot: `data/card/260910.yml` · 2026-09-10T22:22:11Z._
